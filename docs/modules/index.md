[SVG Real Renderer - v0.3.12](../docs.md) / index
...
Defined in: [src/util/renderPreview.ts:8](https://github.com/HarshKhandeparkar/svg-real-renderer/blob/289dbab/src/util/renderPreview.ts#L8)
