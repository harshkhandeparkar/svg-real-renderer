[SVG Real Renderer - v0.3.10](../docs.md) / src/constants/events/RealDrawBoardEvents
...
Defined in: [src/constants/events/RealDrawBoardEvents.ts:18](https://github.com/HarshKhandeparkar/svg-real-renderer/blob/811974a/src/constants/events/RealDrawBoardEvents.ts#L18)
