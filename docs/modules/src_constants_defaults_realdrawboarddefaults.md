[SVG Real Renderer - v0.3.12](../docs.md) / src/constants/defaults/RealDrawBoardDefaults
...
Defined in: [src/constants/defaults/RealDrawBoardDefaults.ts:5](https://github.com/HarshKhandeparkar/svg-real-renderer/blob/289dbab/src/constants/defaults/RealDrawBoardDefaults.ts#L5)
