[SVG Real Renderer - v0.3.4](../docs.md) / src/constants/events/RealRendererEvents
...
Defined in: [src/constants/events/RealRendererEvents.ts:20](https://github.com/HarshKhandeparkar/svg-real-renderer/blob/c1d2f58/src/constants/events/RealRendererEvents.ts#L20)
