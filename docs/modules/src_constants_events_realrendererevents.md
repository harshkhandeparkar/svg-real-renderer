[SVG Real Renderer - v0.3.7](../docs.md) / src/constants/events/RealRendererEvents
...
Defined in: [src/constants/events/RealRendererEvents.ts:20](https://github.com/HarshKhandeparkar/svg-real-renderer/blob/ff87ea8/src/constants/events/RealRendererEvents.ts#L20)
