[SVG Real Renderer - v0.4.3](../docs.md) / src/constants/events/RealRendererEvents
...
Defined in: [src/constants/events/RealRendererEvents.ts:25](https://github.com/HarshKhandeparkar/svg-real-renderer/blob/606fa79/src/constants/events/RealRendererEvents.ts#L25)
