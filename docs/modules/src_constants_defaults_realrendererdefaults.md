...
Defined in: [src/constants/defaults/RealRendererDefaults.ts:3](https://github.com/HarshKhandeparkar/svg-real-renderer/blob/e0bef37/src/constants/defaults/RealRendererDefaults.ts#L3)
