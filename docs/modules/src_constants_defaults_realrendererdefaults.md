[SVG Real Renderer - v0.4.3](../docs.md) / src/constants/defaults/RealRendererDefaults
...
Defined in: [src/constants/defaults/RealRendererDefaults.ts:3](https://github.com/HarshKhandeparkar/svg-real-renderer/blob/606fa79/src/constants/defaults/RealRendererDefaults.ts#L3)
